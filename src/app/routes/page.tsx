/**
 * Routes Page - View and manage saved routes
 */
...
export default function RoutesPage() {
  ...
  async function loadRoutes() {
    ...
    try {
      ...
      try {
        ...
        console.log('Offline mode - using cached routes only');
      }
    } catch (error) {
  ...
  const filteredRoutes = routes.filter(route => {
    ...
    return (
      route.tripName?.toLowerCase().includes(query) ||
