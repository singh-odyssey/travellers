  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        ...
        <input name="destination" required className="mt-1 w-full rounded-lg border px-3 py-2" placeholder="Paris" />
      </div>
      <div>
        <label className="block text-sm font-medium">Departure date</label>
        <input type="date" name="departureDate" required className="mt-1 w-full rounded-lg border px-3 py-2" />
      </div>
      <div>
      ...
      <button type="submit" disabled={loading} className="rounded-lg bg-slate-900 px-4 py-2 font-medium text-white hover:bg-slate-800 disabled:opacity-50">
